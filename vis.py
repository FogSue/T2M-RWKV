...
args.resume_trans = '/home/adam/Desktop/T2M-RWKV/output/rwkv_base_0.5uncond/net_best_fid.pth' #  '' /home/adam/T2M-GPT/output/GPT/rwkv_net_last.pth
args.down_t = 2
args.depth = 3
args.block_size = 256
...
trans_encoder = trans.Text2Motion_RNN(
                                ...
                                embed_dim=768, 
                                clip_dim=args.clip_dim, 
                                block_size= 256, # args.block_size, 
                                num_layers=12, 
                                n_head=16, 
                                drop_out_rate=args.drop_out_rate, 
                                fc_rate=args.ff_rate
