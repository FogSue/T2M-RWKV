...
from models.t2m_trans import DTYPE
...
if args.resume_trans is not None:
    ...
    m = trans.init_weights(trans_encoder, args.embed_dim_gpt, args.num_layers, args.nb_code+2, DTYPE)
...
if m.keys() == trans_encoder.state_dict().keys():
    ...
    for k in m.keys():
            ...
            if not torch.equal(v1, v2):
                print(False)
                continue
trans_encoder = trans_encoder.to(DTYPE)
trans_encoder.train()
trans_encoder.cuda()
